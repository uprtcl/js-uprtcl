...
import { UprtclTypes, UprtclLocal, Perspective, Commit, UprtclRemote } from '../types';
import { UprtclProvider } from './providers/uprtcl.provider';
import { UprtclSource } from './providers/uprtcl.source';
...
export class Uprtcl implements UprtclSource {
  ...
  constructor(
    ...
    @inject(PatternTypes.Core.Secured) protected secured: SecuredPattern<any>,
